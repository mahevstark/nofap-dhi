import 'models/generate_code_one_model.dart';
import 'package:flutter/material.dart';
import 'package:nofapp/core/app_export.dart';
import 'provider/generate_code_one_provider.dart';

// ignore_for_file: must_be_immutable
class GenerateCodeOneDialog extends StatefulWidget {
  const GenerateCodeOneDialog({Key? key})
      : super(
          key: key,
        );

  @override
  GenerateCodeOneDialogState createState() => GenerateCodeOneDialogState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => GenerateCodeOneProvider(),
      child: GenerateCodeOneDialog(),
    );
  }
}

class GenerateCodeOneDialogState extends State<GenerateCodeOneDialog> {
  @override
  void initState() {
    super.initState();
  }
